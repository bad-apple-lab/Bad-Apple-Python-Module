...
py1 -m src.badapple -i archive/NCOP.mkv -s 192:108 -r 10 -c x232w --audio_player auto
py1 -m src.badapple -i archive/1.mp4 -s 192:108 -r 10 -c rgb24 --audio_player auto
py1 -m src.badapple -i archive/Elysia6.mp4 -s 240:0 -r 5 -c fullwidth -m "爱莉希雅死了" --audio_player auto
...
py1 -m badapple -i archive/NCOP.mkv -s 192:108 -r 10 -c x232w --audio_player auto
