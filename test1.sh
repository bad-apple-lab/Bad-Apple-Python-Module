py1 -m badapple --help
py1 -m badapple --avaliable_player
py1 -m badapple
py1 -m badapple -i _BADAPPLE_BADAPPLE --audio archive/your_everything.mp3
py1 -m badapple --audio_player mpv
py1 -m badapple --audio_player aaaa
py1 -m badapple --audio _BADAPPLE_WAV --audio_player vlc
py1 -m badapple --audio _BADAPPLE_MP3 --audio_player mpg123
py1 -m badapple --audio _BADAPPLE_MP3 --audio_player cmus
py1 -m badapple --audio _BADAPPLE_WAV --audio_player simpleaudio
py1 -m badapple --audio _BADAPPLE_MP4 --audio_player pydub
