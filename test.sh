...
py1 -m src.badapple -i archive/87011701_p0.jpg -s 85:98 --contrast
py1 -m src.badapple -i archive/Elysia1.mp4 -o archive/ely.badapple -s 0:72 -r 10
py1 -m src.badapple -i archive/ely.badapple --audio archive/addiction.flac
py1 -m src.badapple -i archive/NCOP.mkv -s 96:0 --contrast --audio_player auto
...
py1 -m badapple -i archive/Elysia1.mp4 -o archive/ely.badapple -s 0:72 -r 10
py1 -m badapple -i archive/ely.badapple --audio archive/addiction.flac
py1 -m badapple -i archive/NCOP.mkv -s 96:0 --contrast --audio_player auto
twine upload dist/*
