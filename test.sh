...
python -m badapple --audio badapple/badapple.wav --audio_player vlc
python -m badapple --audio badapple/badapple.mp3 --audio_player mpg123
python -m badapple --audio badapple/badapple.mp3 --audio_player cmus
...
python -m badapple --audio badapple/badapple.wav --audio_player pydub
