...
py1 -m src.badapple -i archive/Elysia7.mp4 -o archive/ely.badapple -s 160:0 -c rgb24
...
py1 -m src.badapple -i archive/Elysia1.mp4 -r 10 -c fullwidth -m "爱莉希雅死了" --audio_player auto
